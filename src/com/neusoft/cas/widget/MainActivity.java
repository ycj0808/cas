...
//		new Thread(request).start();
	...
	Runnable request = new Runnable(){
		...
		public void run() {
			...
			String result=HttpUtils.sendGet("http://10.4.120.103:8080/cas/techcomp/ria/commonProcessor!login.action","eap_username=admin&eap_password=1&eap_authentication=true");
	...
	class MyTask extends AsyncTask<String,String,Map<String,Object>>{
		...
		protected Map<String, Object> doInBackground(String... params) {
			String result=HttpUtils.sendGet("http://10.4.120.103:8080/cas/techcomp/ria/commonProcessor!login.action", params[0]);
			LogUtils.i(result);
			return null;
		}
