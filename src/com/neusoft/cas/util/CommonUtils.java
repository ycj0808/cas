...
public class CommonUtils {
	/**
	  * @Title:获取手机的信息 
	  * mBrand 手机品牌,mType 手机型号,mImei  设备号,mImsi ,mNumber 手机号,mSserviceName 运营商
	  * @Description: TODO
	...
	public static Map<String,String> getPhoneInfo(Context mContext){
		...
		TelephonyManager telphony=(TelephonyManager)mContext.getSystemService(Context.TELEPHONY_SERVICE);
